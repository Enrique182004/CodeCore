...
<footer class="ch-footer">
  <div class="ch-footer-inner">
    <div>
      ...
      <p>Empowering El Paso elementary and middle school students through STEM, coding, and responsible AI education. A program of CodeCore at UTEP.</p>
      <div class="ch-footer-social">
        ...
        <a href="https://www.linkedin.com/in/codecoreutep/" target="_blank" rel="noopener" aria-label="LinkedIn">
    ...
    <div>
      ...
      <p>CodeCore Chapter is the grades 3–8 outreach program of CodeCore at UTEP — bringing the next generation of El Paso coders into the fold.</p>
      <a href="../index.html" class="ch-footer-main-link">Visit CodeCore.org →</a>
    </div>
  </div>
  <div class="ch-footer-bottom">
    <p>© 2026 CodeCore Chapter · El Paso Elementary &amp; Middle Schools · <a href="../index.html">Part of CodeCore at UTEP</a></p>
  </div>
</footer>`;
}
