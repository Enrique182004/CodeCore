...
const WORKSHOP_CONFIG = {
  "recursion-seats": {
    ...
    apiUrl:
      "https://script.google.com/macros/s/AKfycbzCgBZ7AL0aEzQjzWgY2kl_Wx0o-QUb-cM9dwyMYbNCAT8mmdOuJH4ELy6xJ7zat3Ba/exec",
  },
...
async function updateSeatCount(workshopId) {
  ...
  if (!config.apiUrl) {
    console.log(
      `No API URL configured for ${workshopId}. Using default value.`,
    );
    return;
  }
